...
# Food and Beverages
fuel_switch(economy = '05_PRC', sector = ind2[6], elec_rate_tgt = 0.0075, c2g_rate_tgt = 0.0025)
...
# Korea
# Mining
fuel_switch(economy = '09_ROK', sector = ind1[0], elec_rate_tgt = 0.006)

# Construction
fuel_switch(economy = '09_ROK', sector = ind1[1], elec_rate_tgt = 0.0075, 
            elec_start_ref = 2024, elec_start_tgt = 2024)
...
# Chemicals
fuel_switch(economy = '09_ROK', sector = ind2[1], elec_rate_ref = 0.002, elec_rate_tgt = 0.004,
            hydrogen_ref = False, hydrogen_tgt = True, ccs_ref = False, ccs_tgt = True,
            c2g_rate_ref = 0.001, c2g_rate_tgt = 0.002, 
            hyd_start_tgt = 2030, hyd_increment_tgt = 0.001, hyd_fuel_mix = {'16_x_hydrogen': 1.0, '17_electricity': 0.0})

# Non-ferrous metals
fuel_switch(economy = '09_ROK', sector = ind2[2], elec_rate_tgt = 0.006, c2g_rate_ref = 0.001, 
            c2g_rate_tgt = 0.001)

# Non-metallic minerals
fuel_switch(economy = '09_ROK', sector = ind2[3], elec_rate_ref = 0.0015, elec_rate_tgt = 0.003, 
            ccs_ref = False, ccs_tgt = True, c2g_rate_tgt = 0.003, hydrogen_tgt = True,
            hyd_start_tgt = 2030, hyd_increment_tgt = 0.001, hyd_fuel_mix = {'16_x_hydrogen': 1.0, '17_electricity': 0.0})

# Transport
fuel_switch(economy = '09_ROK', sector = ind2[4], elec_rate_ref = 0.003, elec_rate_tgt = 0.006)

# Machinery
fuel_switch(economy = '09_ROK', sector = ind2[5], elec_rate_ref = 0.003, elec_rate_tgt = 0.005)

# Food and Beverages
fuel_switch(economy = '09_ROK', sector = ind2[6], elec_rate_tgt = 0.0075, c2g_rate_tgt = 0.0025)
...
# Textiles
fuel_switch(economy = '09_ROK', sector = ind2[9], elec_rate_ref = 0.003, elec_rate_tgt = 0.0075)

# Non-specified
fuel_switch(economy = '09_ROK', sector = ind2[10], elec_rate_tgt = 0.01, c2g_rate_tgt = 0.003)
...
fuel_switch(economy = '11_MEX', sector = ind2[0], elec_rate_ref = 0.003, elec_rate_tgt = 0.005, 
            ...
            hyd_start_tgt = 2035, hyd_increment_tgt = 0.005)
...
fuel_switch(economy = '11_MEX', sector = ind2[3], elec_rate_ref = 0.0015, elec_rate_tgt = 0.003, 
            ccs_ref = True, ccs_tgt = True, c2g_rate_tgt = 0.004, hydrogen_tgt = True, hyd_start_tgt = 2035, 
            hyd_increment_tgt = 0.001, hyd_fuel_mix = {'16_x_hydrogen': 0.8, '17_electricity': 0.2})
...
# Iron and steel
# fuel_switch(economy = '17_SIN', sector = ind2[0], elec_rate_ref = 0.003, elec_rate_tgt = 0.0075, 
...
# # Non-ferrous metals
# fuel_switch(economy = '17_SIN', sector = ind2[2])

# # Non-metallic minerals
# fuel_switch(economy = '17_SIN', sector = ind2[3], elec_rate_ref = 0.0015, elec_rate_tgt = 0.005, c2g_rate_tgt = 0.002,
#             hydrogen_tgt = True, hyd_start_tgt = 2030, hyd_increment_tgt = 0.001, hyd_fuel_mix = {'16_x_hydrogen': 1.0, '17_electricity': 0.0})

# # Transport
# fuel_switch(economy = '17_SIN', sector = ind2[4])

# # Machinery
# fuel_switch(economy = '17_SIN', sector = ind2[5])

# # Food and Beverages
# fuel_switch(economy = '17_SIN', sector = ind2[6], elec_rate_tgt = 0.008)

# # Pulp and paper
# fuel_switch(economy = '17_SIN', sector = ind2[7], elec_rate_ref = 0.0025, elec_rate_tgt = 0.008, 
#             bio_rate_ref = 0.001, bio_rate_tgt = 0.005)

# # Wood
# fuel_switch(economy = '17_SIN', sector = ind2[8])

# # Textiles
# fuel_switch(economy = '17_SIN', sector = ind2[9], elec_rate_ref = 0.0075, elec_rate_tgt = 0.01, 
