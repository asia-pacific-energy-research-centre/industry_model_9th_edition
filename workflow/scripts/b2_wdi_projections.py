...
ind_projection(economy = '01_AUS', series = 'NV.IND.TOTL.ZS', high_bound = 30)
# Manufacturing % GDP
ind_projection(economy = '01_AUS', series = 'NV.IND.MANF.ZS', low_bound = 5)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '01_AUS', series = 'NV.MNF.CHEM.ZS.UN', high_bound = 7, high_change = 0.9992)
# Food and beverage
ind_projection(economy = '01_AUS', series = 'NV.MNF.FBTO.ZS.UN', low_bound = 34, high_bound = 35)
# Machinery and Transport
ind_projection(economy = '01_AUS', series = 'NV.MNF.MTRN.ZS.UN')
# Other manufacturing
ind_projection(economy = '01_AUS', series = 'NV.MNF.OTHR.ZS.UN', low_bound = 55, high_bound = 60, low_change = 1.0005)
# Textiles
ind_projection(economy = '01_AUS', series = 'NV.MNF.TXTL.ZS.UN', low_bound = 0.5, high_bound = 1, high_change = 0.995) 

##############################################################################################
# 02_BD
# Industry (including construction) % GDP
ind_projection(economy = '02_BD', series = 'NV.IND.TOTL.ZS')
# Manufacturing % GDP
ind_projection(economy = '02_BD', series = 'NV.IND.MANF.ZS', low_bound = 30, high_bound = 35, low_change = 1.0015)
...
# Manufacturing % GDP
ind_projection(economy = '03_CDA', series = 'NV.IND.MANF.ZS', low_bound = 7, high_bound = 8)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '03_CDA', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
...
# Manufacturing % GDP
ind_projection(economy = '04_CHL', series = 'NV.IND.MANF.ZS', low_bound = 5, high_bound = 8)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '04_CHL', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
ind_projection(economy = '04_CHL', series = 'NV.MNF.FBTO.ZS.UN', low_bound = 50, high_bound = 55)
# Machinery and Transport
ind_projection(economy = '04_CHL', series = 'NV.MNF.MTRN.ZS.UN')
# Other manufacturing
ind_projection(economy = '04_CHL', series = 'NV.MNF.OTHR.ZS.UN', low_bound = 50, high_bound = 60)
# Textiles
...
# 05_PRC
# Industry (including construction) % GDP
ind_projection(economy = '05_PRC', series = 'NV.IND.TOTL.ZS')
# Manufacturing % GDP
ind_projection(economy = '05_PRC', series = 'NV.IND.MANF.ZS')
...
# 06_HKC
# Industry (including construction) % GDP
ind_projection(economy = '06_HKC', series = 'NV.IND.TOTL.ZS', low_bound = 5, high_bound = 7)
# Manufacturing % GDP
ind_projection(economy = '06_HKC', series = 'NV.IND.MANF.ZS', low_bound = 0.5, high_bound = 1)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '06_HKC', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
ind_projection(economy = '06_HKC', series = 'NV.MNF.FBTO.ZS.UN', low_bound = 45, high_bound = 50)
# Machinery and Transport
...
# 07_INA
# Industry (including construction) % GDP
ind_projection(economy = '07_INA', series = 'NV.IND.TOTL.ZS', low_bound = 35, high_bound = 45)
# Manufacturing % GDP
ind_projection(economy = '07_INA', series = 'NV.IND.MANF.ZS')

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '07_INA', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
ind_projection(economy = '07_INA', series = 'NV.MNF.FBTO.ZS.UN')
# Machinery and Transport
ind_projection(economy = '07_INA', series = 'NV.MNF.MTRN.ZS.UN')
# Other manufacturing
ind_projection(economy = '07_INA', series = 'NV.MNF.OTHR.ZS.UN')
# Textiles
ind_projection(economy = '07_INA', series = 'NV.MNF.TXTL.ZS.UN')

###############################################################################################
# 08_JPN
# Industry (including construction) % GDP
ind_projection(economy = '08_JPN', series = 'NV.IND.TOTL.ZS', low_bound = 22, high_bound = 25, high_change = 0.9995)
# Manufacturing % GDP
ind_projection(economy = '08_JPN', series = 'NV.IND.MANF.ZS', low_bound = 25, high_bound = 16, high_change = 0.9995)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '08_JPN', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
ind_projection(economy = '08_JPN', series = 'NV.MNF.FBTO.ZS.UN')
# Machinery and Transport
ind_projection(economy = '08_JPN', series = 'NV.MNF.MTRN.ZS.UN', low_bound = 40, high_bound = 50)
# Other manufacturing
...
# Manufacturing % GDP
ind_projection(economy = '09_ROK', series = 'NV.IND.MANF.ZS')

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '09_ROK', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
ind_projection(economy = '09_ROK', series = 'NV.MNF.FBTO.ZS.UN')
# Machinery and Transport
...
# Manufacturing % GDP
ind_projection(economy = '10_MAS', series = 'NV.IND.MANF.ZS', high_bound = 17)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '10_MAS', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
...
# 11_MEX
# Industry (including construction) % GDP
ind_projection(economy = '11_MEX', series = 'NV.IND.TOTL.ZS', low_bound = 25, high_bound = 30, high_change = 0.9999)
# Manufacturing % GDP
ind_projection(economy = '11_MEX', series = 'NV.IND.MANF.ZS', low_bound = 13, high_bound = 15)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '11_MEX', series = 'NV.MNF.CHEM.ZS.UN', low_bound = 15)
# Food and beverage
ind_projection(economy = '11_MEX', series = 'NV.MNF.FBTO.ZS.UN', low_bound = 30, high_bound = 35, low_change = 1.0005)
# Machinery and Transport
...
# Textiles
ind_projection(economy = '11_MEX', series = 'NV.MNF.TXTL.ZS.UN', low_bound = 2, high_bound = 2.5)

###############################################################################################
# 12_NZ
# Industry (including construction) % GDP
ind_projection(economy = '12_NZ', series = 'NV.IND.TOTL.ZS', low_bound = 5, high_bound = 10)
# Manufacturing % GDP
ind_projection(economy = '12_NZ', series = 'NV.IND.MANF.ZS', low_bound = 5, high_bound = 7)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '12_NZ', series = 'NV.MNF.CHEM.ZS.UN', low_bound = 2, high_bound = 3)
# Food and beverage
ind_projection(economy = '12_NZ', series = 'NV.MNF.FBTO.ZS.UN', low_bound = 45, high_bound = 50)
# Machinery and Transport
...
# 13_PNG
# Industry (including construction) % GDP
ind_projection(economy = '13_PNG', series = 'NV.IND.TOTL.ZS', low_bound = 35, high_bound = 40)
# Manufacturing % GDP
ind_projection(economy = '13_PNG', series = 'NV.IND.MANF.ZS', low_change = 1.005)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '13_PNG', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
...
# Textiles
ind_projection(economy = '13_PNG', series = 'NV.MNF.TXTL.ZS.UN')

###############################################################################################
# 14_PE
# Industry (including construction) % GDP
ind_projection(economy = '14_PE', series = 'NV.IND.TOTL.ZS', low_bound =  25, high_bound = 35)
# Manufacturing % GDP
ind_projection(economy = '14_PE', series = 'NV.IND.MANF.ZS')

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '14_PE', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
...
# Textiles
ind_projection(economy = '14_PE', series = 'NV.MNF.TXTL.ZS.UN')
...
# Manufacturing % GDP
ind_projection(economy = '15_RP', series = 'NV.IND.MANF.ZS', low_bound = 10, high_bound = 14)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '15_RP', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
...
# 16_RUS
# Industry (including construction) % GDP
ind_projection(economy = '16_RUS', series = 'NV.IND.TOTL.ZS', low_bound = 30, high_bound = 31)
# Manufacturing % GDP
ind_projection(economy = '16_RUS', series = 'NV.IND.MANF.ZS')

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '16_RUS', series = 'NV.MNF.CHEM.ZS.UN', low_bound = 15)
# Food and beverage
...
# Manufacturing % GDP
ind_projection(economy = '17_SIN', series = 'NV.IND.MANF.ZS', high_bound = 15)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '17_SIN', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
...
# 19_THA
# Industry (including construction) % GDP
ind_projection(economy = '19_THA', series = 'NV.IND.TOTL.ZS')
# Manufacturing % GDP
ind_projection(economy = '19_THA', series = 'NV.IND.MANF.ZS')

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '19_THA', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
ind_projection(economy = '19_THA', series = 'NV.MNF.FBTO.ZS.UN')
# Machinery and Transport
ind_projection(economy = '19_THA', series = 'NV.MNF.MTRN.ZS.UN')
# Other manufacturing
ind_projection(economy = '19_THA', series = 'NV.MNF.OTHR.ZS.UN')
# Textiles
...
# 20_USA
# Industry (including construction) % GDP
ind_projection(economy = '20_USA', series = 'NV.IND.TOTL.ZS', high_bound = 17, high_change = 0.9999)
# Manufacturing % GDP
ind_projection(economy = '20_USA', series = 'NV.IND.MANF.ZS', low_bound = 5, high_bound = 10, high_change = 0.9999)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '20_USA', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
...
# Manufacturing % GDP
ind_projection(economy = '21_VN', series = 'NV.IND.MANF.ZS', low_bound = 28, high_bound = 30, low_change = 1.0005)

# Subsets of Manufacturing (% of Manufacturing)
# Chemicals
ind_projection(economy = '21_VN', series = 'NV.MNF.CHEM.ZS.UN')
# Food and beverage
...
for economy in wdi_df['economy_code'].unique():
    filenames = glob.glob('./data/industry_projection/{}/*.csv'.format(economy))
    for i in filenames:
        temp_df = pd.read_csv(i)
        combined_df = pd.concat([combined_df, temp_df]).copy()

combined_df.to_csv('./data/industry_projection/wdi_projections.csv', index = False)